...
class BackgroundScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('sky_gradient', 'assets/data/images/backgrounds/sky_gradient.png');
        this.load.image('mountains_far', 'assets/data/images/backgrounds/mountains_dark.png');
        this.load.image('mountains_mid', 'assets/data/images/backgrounds/mountains_blue.png');
        this.load.image('hills_dark', 'assets/data/images/backgrounds/hills_dark.png');
        this.load.image('forest_line', 'assets/data/images/backgrounds/forest_line.png');
        this.load.image('clouds', 'assets/data/images/backgrounds/clouds.png');
    }
